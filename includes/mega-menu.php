<div id="page-header" role="banner"><a id="skip-to-main-content" href="#breadcrumb-holder">Skip to Main Content</a>
  <section class="row container">
    <article class="col starts-at-full ends-at-half clr" id="logo-holder">
      ...
      <a href="http://www.nationalarchives.gov.uk" title="Go to The National Archives homepage"> <img src="http://www.nationalarchives.gov.uk/wp-content/themes/tna/images/global/logo-white.png" alt="The National Archives" id="logo"/> </a> </article>
    <article class="col starts-at-full ends-at-half clr">
      <form action="http://apps.nationalarchives.gov.uk/search/quick_search.aspx" method="get" id="mobileGlobalSearch">
        <div id="mobile-search-outer-wrapper">
          ...
          <div id="changeDestination">
            <input checked type="radio" class="mobileSearchDestinationOption" name="searchDestination" id="websiteSearch" data-target="http://apps.nationalarchives.gov.uk/search/quick_search.aspx" data-placeholder="Search our website..." data-fieldName="search_text"/>
      ...
      <div id="search-field-wrapper">
        <form action="http://apps.nationalarchives.gov.uk/search/quick_search.aspx" method="get" id="globalSearch">
        ...
        <ul id="search-options">
          <li><a href="#" class="formDestinationChanger" data-target="http://apps.nationalarchives.gov.uk/search/quick_search.aspx" data-placeholder="Search our website..." data-fieldName="search_text" role="button" aria-label="Change form destination to search the website">Search our website</a></li>
...
<div class="mega-menu" role="navigation">
  <section class="row">
    ...
    <nav class="col mega-menu-group clr">
      <div>
        <h3><a onClick="dcsMultiTrack('DCS.dcsuri','/menu/Records ','WT.ti','Menu - Records ');" href="http://www.nationalarchives.gov.uk/records">Records</a></h3>
        <ul>
          <li class="mobileOnly"><a onClick="dcsMultiTrack('DCS.dcsuri','/menu/Records ','WT.ti','Menu - Records ');" href="/records">Records home</a></li>
          ...
          <li><a onClick="dcsMultiTrack('DCS.dcsuri','/menu/Looking for a person ','WT.ti','Menu - Looking for a person ');" href="/records/looking-for-person/">Looking for a person</a></li>
          <li><a onClick="dcsMultiTrack('DCS.dcsuri','/menu/Looking for a place ','WT.ti','Menu - Looking for a place ');" href="/records/looking-for-place/">Looking for a place</a></li>
          <li><a onClick="dcsMultiTrack('DCS.dcsuri','/menu/Looking for a subject ','WT.ti','Menu - Looking for a subject ');" href="/records/looking-for-subject/">Looking for a subject</a></li>
          <li><a onClick="dcsMultiTrack('DCS.dcsuri','/menu/Records guidance A-Z ','WT.ti','Menu - Guidance A-Z ');" href="/records/atoz/">Records guidance A-Z</a></li>
          <li><a onClick="dcsMultiTrack('DCS.dcsuri','/menu/Our online records ','WT.ti','Menu - Our online records ');" href="/records/our-online-records.htm">Our online records</a></li>
          ...
          <li><a onClick="dcsMultiTrack('DCS.dcsuri','/menu/Certificates of British Citizenship ','WT.ti','Menu - Certificates of British Citizenship ');" href="/records/citizenship-and-naturalisation.htm">Certificates of British Citizenship</a></li>
